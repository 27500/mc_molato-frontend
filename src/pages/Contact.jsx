  ...
  return (
    <div className="py-8 px-4 max-w-[1200px] mx-auto text-gray-900">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <ScrollReveal animation="fade-right" delay={150} className="lg:col-span-1 h-full">
          <div className="bg-[#f7f7f7] border border-gray-200/80 rounded-[2.5rem] p-8 flex flex-col justify-between gap-8 h-full">
            <div>
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                {/* Instagram */}
                <a href="https://www.instagram.com/mc_molato_style?igsh=NGYyZGN2c3FweGpr" target="_blank" rel="noreferrer" title="Instagram" className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-700 hover:bg-black hover:text-white transition shadow-sm">
                ...
                {/* TikTok */}
                <a href="https://www.tiktok.com/@mc.molato?_r=1&_d=egi6ieal4leid9&sec_uid=MS4wLjABAAAAbTe--Oc8wciEOXE0KcyJF34t4pn06cPakYm8qsLCmMF8af-CHCvsCuzIvbgpb6Fc&share_author_id=7375961954554856454&sharer_language=fr&source=h5_m&u_code=eed675hd72g21f&ug_btm=b8727,b0&social_share_type=4&utm_source=copy&sec_user_id=MS4wLjABAAAAbTe--Oc8wciEOXE0KcyJF34t4pn06cPakYm8qsLCmMF8af-CHCvsCuzIvbgpb6Fc&tt_from=copy&utm_medium=ios&utm_campaign=client_share&enable_checksum=1&user_id=7375961954554856454&share_link_id=131760E0-4F88-439E-8D50-FD5100C68DE9&share_app_id=1233&ug_btm=b8727,b0&sec_user_id=MS4wLjABAAAAbTe--Oc8wciEOXE0KcyJF34t4pn06cPakYm8qsLCmMF8af-CHCvsCuzIvbgpb6Fc&utm_source=whatsapp&social_share_type=5&utm_campaign=client_share&utm_medium=ios&tt_from=whatsapp&user_id=7375961954554856454&enable_checksum=1&share_link_id=F8CBFB1E-4E69-417D-B085-AAF692AC698B&share_app_id=1233" target="_blank" rel="noreferrer" title="TikTok" className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-700 hover:bg-black hover:text-white transition shadow-sm">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/></svg>
                </a>
                {/* WhatsApp */}
                <a href="https://wa.me/message/3ZLSKTN7VVIYB1" target="_blank" rel="noreferrer" title="WhatsApp" className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-700 hover:bg-black hover:text-white transition shadow-sm">
